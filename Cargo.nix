...
let
  nixifiedLockHash = "13d034a2c35c25a7ef1ea323c55d11e303acff44ee8bec63f59addf8a1aba84a";
  ...
  in
  {
    ...
    "git+https://github.com/meta-introspector/rust-base64".base64."0.22.1" = overridableMkRustCrate (profileName: rec {
      ...
      src = fetchCrateGit {
        ...
        name = "base64";
        version = "0.22.1";
        rev = "7c30912009f31b602ec2085398b9a0334553e3c2";
        ref = "feature/CRQ-016-nixify";
      };
      features = builtins.concatLists [
        [ "alloc" ]
    ...
    "unknown".cargo2nix."0.12.0" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        ...
        dashmap = (rustPackages."git+https://github.com/meta-introspector/dashmap".dashmap."7.0.0-rc2" { inherit profileName; }).out;
    ...
    "git+https://github.com/meta-introspector/dashmap".dashmap."7.0.0-rc2" = overridableMkRustCrate (profileName: rec {
      name = "dashmap";
      version = "7.0.0-rc2";
      registry = "git+https://github.com/meta-introspector/dashmap";
      src = fetchCrateGit {
        url = "https://github.com/meta-introspector/dashmap";
        name = "dashmap";
        version = "7.0.0-rc2";
        rev = "6846c9ae62a9c4aa40553a98f3f1a21b68da850f";
        ref = "feature/CRQ-016-nixify";
      };
      dependencies = {
        cfg_if = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."1.0.4" { inherit profileName; }).out;
    ...
    "git+https://github.com/meta-introspector/dlv-list-rs".dlv-list."0.6.0" = overridableMkRustCrate (profileName: rec {
      ...
      src = fetchCrateGit {
        ...
        name = "dlv-list";
        version = "0.6.0";
        rev = "cdeb3c243e164a68316f25ee96065d3ad87ee7cf";
        ref = "feature/CRQ-016-nixify";
      };
      features = builtins.concatLists [
        [ "default" ]
    ...
    "git+https://github.com/meta-introspector/hashbrown".hashbrown."0.16.0" = overridableMkRustCrate (profileName: rec {
      ...
      src = fetchCrateGit {
        ...
        name = "hashbrown";
        version = "0.16.0";
        rev = "b5136087f559cab6f4592bd7204108f77bb201a0";
        ref = "feature/CRQ-016-nixify";
      };
      features = builtins.concatLists [
        [ "allocator-api2" ]
