description = "Modify `cargo-repo-sync` to interact with the local `rollup.lock` file to read and update the global state, replacing its internal Git status logic with queries to this local file."
steps = [
