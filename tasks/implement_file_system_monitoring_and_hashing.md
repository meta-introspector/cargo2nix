description = "Develop a component that monitors file system changes (e.g., using `notify` crate) and efficiently calculates content hashes for changed files. This component will update the in-memory representation of the `rollup.lock` data."
steps = [
