description = "Define the schema for the `rollup.lock` file, which will store cached file system metadata, file hashes, and Git status information for the main repository and all submodules. This schema should be robust and file-system-friendly."
steps = [
