...
impl BuildReasoner {
    ...
    fn populate_cache(&mut self) {
        ...
        self.cache.insert("solana".to_string(), BuildGoal {
        ...
        self.cache.insert("rust".to_string(), BuildGoal {
        ...
        self.cache.insert("rustc".to_string(), BuildGoal {
        ...
        self.cache.insert("cargo".to_string(), BuildGoal {
        ...
        self.cache.insert("serde".to_string(), BuildGoal {
    ...
    fn resolve_dependencies(&self, target: &str, plan: &mut Vec<String>) {
        if let Some(build_goal) = self.cache.get(target) {
            ...
            if !plan.contains(&target.to_string()) {
                plan.push(format!("build({}) [cached:{}, git:{}]", 
    ...
    fn graphql_query(&self, goal: &str) -> String {
        ...
        let mut result = format!("query BuildReasoning {{\n  goal: \"{}\"\n  buildPlan: [\n", goal);
