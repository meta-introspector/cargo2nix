...
pub fn add_workspace_submodules(root_dir: &Path, dry_run: bool) -> Result<(), Box<dyn std::error::Error>> {
...
pub fn comment_submodule_workspaces(root_dir: &Path, dry_run: bool) -> Result<(), Box<dyn std::error::Error>> {
