...
# Patch for hyper/src/proto/h1/role.rs - maybe_panic! semicolons
sed -i 's|};;;;|})|g' submodules/hyper/src/proto/h1/role.rs
# Patch for hyper/src/proto/h1/role.rs - header_name! syntax
sed -i '/macro_rules! header_name {/,/};;}/c\
...
' submodules/hyper/src/proto/h1/role.rs
# Patch for hyper/src/proto/h1/role.rs - header_value! syntax
sed -i '/macro_rules! header_value {/,/};;};/c\
...
' submodules/hyper/src/proto/h1/role.rs
# Patch for hyper/src/proto/h1/role.rs - extra closing brace in Client::parse
sed -i '/^        }/d' submodules/hyper/src/proto/h1/role.rs
