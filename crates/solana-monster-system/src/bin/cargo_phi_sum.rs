...
fn calculate_total_phi_sum(
    crate_name: &str,
    crates: &HashMap<String, CratePhi>,
...
fn main() {
    ...
    crates.insert(
        ...
        CratePhi {
            ...
            phi_value: analyze_crate_ast(
                "struct Serialize; trait Deserialize; fn serialize(); impl Serialize for String;",
            ),
            dependencies: vec![],
            total_phi_sum: 0,
        },
    ...
    crates.insert(
        ...
        CratePhi {
            ...
            phi_value: analyze_crate_ast(
                "struct Runtime; enum Poll; fn spawn(); fn block_on(); use std::future::Future;",
            ),
            dependencies: vec![],
            total_phi_sum: 0,
        },
    ...
    crates.insert(
        ...
        CratePhi {
            ...
            phi_value: analyze_crate_ast(
                "struct Client; enum Method; fn get(); fn post(); use serde::Serialize;",
            ),
    ...
    crates.insert(
        ...
        CratePhi {
            ...
            phi_value: analyze_crate_ast(
                "struct App; fn main(); use reqwest::Client; use serde::Deserialize;",
            ),
