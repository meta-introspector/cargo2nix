...
impl From<crate::wodzicki_residue_zkp::ResidueError> for IntegrityError {
    fn from(err: crate::wodzicki_residue_zkp::ResidueError) -> Self {
        IntegrityError::CryptographicVerificationFailed
    }
}
